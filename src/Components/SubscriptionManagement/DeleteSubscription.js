...
const DeleteSubscription = ({deleteOpen, setDeleteOpen, toBeDeleted, setSubscriptionUpdated, subscriptionUpdated }) => {
    ...
    const handleDeleteSubscription = (e) => {
        e.preventDefault();
        const subscriptionId = toBeDeleted.id
        ...
        axios.delete(`${RetrieveUpdateDeleteSubscriptionPlans}${subscriptionId}/`, {
            headers: { 
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-lg">
                    ...
                    <div className="sm:flex sm:items-start">
                        ...
                        <div className="mt-3  sm:ml-4 sm:mt-0 sm:text-left w-full">
                            ...
                            <p>Are you sure you want to delete the subscription type <span className='text-lg font-medium'> "{toBeDeleted.type}"</span></p>
                            
                            <form onSubmit={ (e)=>handleDeleteSubscription(e)}>
