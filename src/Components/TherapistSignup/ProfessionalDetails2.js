...
import FormInputTherapist2 from '../Form/FormInputTherapist2';

const ProfessionalDetails2 = ({prevStep, nextStep, handleChange, changeHandlerResume, details, handleDelete, handleLanguage, languages}) => {
  ...
  return (
    ...
    <div className=" relative border flex flex-col min-w-0 break-words  mb-6 shadow-lg rounded-lg bg-blueGray-100 md:p-10 md:m-12">
        ...
        <FormInputTherapist2 handleChange={handleChange} changeHandlerResume={changeHandlerResume} details={details} handleDelete={handleDelete} handleLanguage={handleLanguage} languages={languages} />
