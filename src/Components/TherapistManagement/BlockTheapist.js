...
const BlockTheapist = ({blockOpen, setBlockOpen, toBeBlocked, setTherapstTableUpdated, therapistTableUpdated }) => {

    const cancelButtonRef = useRef(null)

    const thrapistId = toBeBlocked.id

const handleBlockTherapist = (e) => {
    e.preventDefault();
    ...
    axios.put(`${RetrieveUpdateDeleteTherapist}${thrapistId}/`,body, {
        headers: { 
...
const handleUnblockTherapist = (e)=> {
  ...
  return (
    ...
    <div><Transition.Root show={blockOpen} as={Fragment}>
                        ...
                        <div className="mt-3  sm:ml-4 sm:mt-0 sm:text-left w-full">
                            ...
                            <p>Are you sure you want to block the client <span className='text-lg font-medium'> "{toBeBlocked.name}"</span></p>
                                ...
                                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 justify-center">
                                    ...
                                    onClick={(e)=>handleUnblockTherapist(e)}
                                    >
                                    Unblock
                                    </button> 
                                    : 
                                    ...
                                    type="button"
                                    className=" rounded-md bg-orange-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 sm:ml-3 sm:w-auto"
                                    onClick={(e)=>handleBlockTherapist(e)}
                                    >
                                    block
                                    </button> 
                                    }
