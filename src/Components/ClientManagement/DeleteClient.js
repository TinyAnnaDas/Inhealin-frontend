...
const DeleteClient = ({deleteOpen, setDeleteOpen, toBeDeleted, setUserTableUpdated, userTableUpdated }) => {

    const cancelButtonRef = useRef(null)

    const handleDeleteUser = (e) => {
        e.preventDefault();
        const clientId = toBeDeleted.id
        ...
        axios.delete(`${RetrieveUpdateDeleteClient}${clientId}`, {
            headers: { 
