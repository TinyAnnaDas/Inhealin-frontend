...
const Footer = () => {
  ...
  return (
    ...
    <footer className="relative z-10 bg-white p-5 pt-[120px] ">
        <div className="container mx-auto">
            <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                <div className="mb-10 w-full">
                <a href="/#" className="mb-3 inline-block max-w-[160px]">

                    <img alt='logo' className='className="max-w-full"'  src= {require("../../assets/Logo.png")}/>
                
                </a>
                <p className="text-body-color mb-7 text-base">
                Edathuruthikaran Holdings, 10/450-2, 
                Kundannoor, Maradu, Ernakulam, 
                Kerala 682304
                tinyannadas@gmail.com
                </p>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                ...
                <ul>
                    <li>
                    <a onClick={()=>navigate("/therapist/get-onboard")}
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div className="mb-10 w-full">
                <h4 className="text-dark mb-9 text-lg font-semibold">Legal Stuff</h4>
                <ul>
                    <li>
                    <a
                        href="/#"
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                ...
                <div className="mb-6 flex items-center">
                    <a
                        href="https://www.facebook.com/tiny.paulchristhudas"
                    ...
                    <a
                    href="https://twitter.com/tinyannadas"
                    className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                    >
                    <svg
                        width="16"
                    ...
                    <a
                    href="https://www.instagram.com/tinyannadas/"
                    className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                    >
                    <svg
                        width="16"
                    ...
                    <a
                    href="https://www.linkedin.com/in/tinyannadas/"
                    className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                    >
                    <svg
                        width="14"
